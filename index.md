...
1. **Happiness**: I believe that love and happiness are life's highest purposes.
...
4. **Integrity**: I build the future by facing reality at every turn, without lies or exaggeration.
5. **Justice**: I pursue choices that are just and reasonable, as well as practical.
6. **Passion**: I value working hard and finding pleasure in my work.
7. **Strength**: I strive for physical, intellectual, economic, and aesthetic excellence.
8. **Collaboration**: I see collaboration as the only way to achieve ambitious goals.
9. **Learning**: I hold that learning should continue throughout life.
...
- **2026.01.** Clinical trial completed at HUINNO, "Clinical Validity of an AI-Based Biological Signal Analysis Software Vital-PICASO for Predicting the Risk of Hypotension within 24hrs Using Vital Sign (SBP, DBP, HR, RR, BT, SpO2) from General Ward Inpatients; A Retrospective, Single-Center, Single-Arm, Superiority-Confirmatory Clinical Trial".

- **2025.11.** Clinical trial completed at HUINNO, "Clinical Validity of an AI-Based Biological Signal Analysis Software Vital-PICASO for Predicting the Risk of Cardiac Arrest within 24hrs Using Vital Sign (SBP, DBP, HR, RR, BT, SpO2) from General Ward Inpatients; A Retrospective, Single-Center, Single-Arm, Superiority-Confirmatory Clinical Trial".

- **2025.05.** Accepted, "ECG-GraphNet: Advanced Arrhythmia Classification Based on Graph Convolutional Networks", **Myeonghun Lee**<sup>+</sup>, Jiwoo Lim<sup>+</sup>, and Jinkook Kim\*, <span style="color:red">Heart Rhythm O2</span>. [<a href="https://www.heartrhythmopen.com/article/S2666-5018(25)00162-X/fulltext">Link</a>] 
...
- **2021.11.** 2021 Research Data AI Analysis Utilization Contest, "Singlet-Triplet Energy Gap Prediction Using Graph Convolutional Network", The Excellence Prize (National Research Council of Science & Technology Chairman's Award, 국가과학기술연구회 이사장상). [<a href="https://www.kisti.re.kr/promote/post/news/5422?t=1641877298563">Link</a>] 
...
- **2021.09.** ACS Fall 2021 Conference Submission, "Graph Convolutional Network for Organic Solvent and Aqueous Solubility Prediction", **Myeonghun Lee**<sup>+</sup>, Sumin Lee, Ki-Won Gyak, Sung Dug Kim, Mi-Jeong Kim\*, and Kyoungmin Min\*. [<a href="https://doi.org/10.1021/scimeetings.1c01189">Link</a>] 
